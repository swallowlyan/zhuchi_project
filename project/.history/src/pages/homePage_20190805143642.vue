    ...
    <el-row style="margin:20px 0px">
     ...
     <el-row style="margin:20px 0px">
      ...
      <el-col :span=4 class="recommended_bg">
        <div style="margin-top:25%;color:#ffffff">智能推荐</div>
        <div style="color:#c0c4cc;margin-top:10px">RECOMMENDATION</div>
      </el-col>
      <el-col :span=17 class="softList">
        <el-row style="margin-bottom:10px">
           <el-col :span=4 v-for="(item, index) in demo_img" :key="index">
...
<style scoped>
  ...
  .recommended_bg{background: url("../assets/soft/softDetail_bg.jpg")}
</style>
