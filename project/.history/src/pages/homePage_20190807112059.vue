<template>
  <div id="homePage">
    ...
    <div>
      ...
      :style="{'backgroundImage': 'url(' + assembly_img[0].src + ')','backgroundSize':'cover'}">
        <span class="rotate">
          <el-row><h5><i class="fa fa-pie-chart"></i></h5></el-row>
          <el-row>
            <h5>汽车零部件</h5>
            <h5>企业套装</h5>
            </el-row>
...
<div>      
       <div class="handle" id="two" @click="animateChange($event,2)"><span class="rotate"></span></div>
      <transition enter-active-class="fadeInLeft" leave-active-class="fadeOutLeft" :duration="{ enter:400, leave:200 }">
...
<div>   
       <div class="handle" id="three" @click="animateChange($event,3)"><span class="rotate"></span></div>
      <transition enter-active-class="fadeInLeft" leave-active-class="fadeOutLeft" :duration="{ enter:400, leave:200 }">
        <div v-if="test3" class="animated slide">test111111111</div>
    </transition>
</div>
<div>
      <div class="handle" id="four" @click="animateChange($event,4)"><span class="rotate"></span></div>
      <transition enter-active-class="fadeInLeft" leave-active-class="fadeOutLeft" :duration="{ enter:400, leave:200 }">
