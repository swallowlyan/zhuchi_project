  ...
  <div id="homePage">
    ...
    <div>
      ...
      >
        ...
        <transition enter-active-class="fadeInLeft" leave-active-class="fadeOutLeftBig" :duration="{ enter:400, leave:200 }">
        <div v-if="test1" class="animated slide">
          <br/>
...
<div>      
       ...
       <transition enter-active-class="fadeInLeft" leave-active-class="fadeOutLeftBig" :duration="{ enter:400, leave:200 }">
        <div v-if="test2" class="animated slide">
          <br/>
          <h5>为您提供专业、稳定建模环境，协助您快速</h5>
          <h5>完成三维建模相关内容，助力高效生产</h5>
          <br/>
...
<div>   
       ...
       <transition enter-active-class="fadeInLeft" leave-active-class="fadeOutLeftBig" :duration="{ enter:400, leave:200 }">
        <div v-if="test3" class="animated slide">
          <br/>
          <h5>为您提供专业、稳定建模环境，协助您快速</h5>
          <h5>完成三维建模相关内容，助力高效生产</h5>
          <br/>
...
<div>
      ...
      <transition enter-active-class="fadeInLeft" leave-active-class="fadeOutLeftBig" :duration="{ enter:400, leave:200 }">
        <div v-if="test4" class="animated slide">
          <br/>
          <h5>为您提供专业、稳定建模环境，协助您快速</h5>
          <h5>完成三维建模相关内容，助力高效生产</h5>
          <br/>
...
<div>
      ...
      <transition enter-active-class="fadeInLeft" leave-active-class="fadeOutLeftBig" :duration="{ enter:400, leave:200 }">
        <div v-if="test5" class="animated slide">
          <br/>
          <h5>为您提供专业、稳定建模环境，协助您快速</h5>
          <h5>完成三维建模相关内容，助力高效生产</h5>
          <br/>
...
import animate from 'animate.css'
    export default {
      ...
      methods:{
        ...
        animateChange(index){
          if(index===1)this.test1=!this.test1;
          else if(index===2)this.test2=!this.test2;
          else if(index===3)this.test3=!this.test3;
          else if(index===4)this.test4=!this.test4;
          else this.test5=!this.test5;
