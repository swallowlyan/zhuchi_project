<template>
  <div id="develop_homePage">
    ...
    <el-row style="margin-top:50px">
      ...
      <el-col :span="4">
        <el-row><h2><i class="fa fa-cloud"></i></h2></el-row>
...
<el-row class="Solution">
    ...
    <el-row style="margin-top:50px">
      <el-col :span="4" :offset="4">
        <el-row><h2><i class="el-icon-monitor"></i></h2></el-row>
        <el-row><h3>帮助文档</h3></el-row>
      </el-col>
      <el-col :span="4">
        <el-row><h2><i class="fa fa-home"></i></h2></el-row>
        <el-row><h3>在线咨询</h3></el-row>
      </el-col>
      <el-col :span="4">
        <el-row><h2><i class="fa fa-share-alt"></i></h2></el-row>
