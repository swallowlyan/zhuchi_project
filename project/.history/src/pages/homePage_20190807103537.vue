<template>
  <div id="homePage">
    ...
    <el-row>
      <div class="container">
<div>
      <div class="handle" id="one" @click="animateChange($event,1)"><p class="rotate"></p></div>
      <transition enter-active-class="fadeInLeft" leave-active-class="fadeOutLeft" :duration="{ enter:400, leave:200 }">
        <h3 v-if="test1" class="animated slide">test111111111</h3>
    </transition>
</div>
<div>      
       <div class="handle" id="two" @click="animateChange($event,2)"><p class="rotate"></p></div>
      <transition enter-active-class="fadeInLeft" leave-active-class="fadeOutLeft" :duration="{ enter:400, leave:200 }">
        <h3 v-if="test2" class="animated">test111111111</h3>
    </transition>
</div>

<div>   
       <div class="handle" id="three" @click="animateChange($event,3)"><p class="rotate"></p></div>
      <transition enter-active-class="fadeInLeft" leave-active-class="fadeOutLeft" :duration="{ enter:400, leave:200 }">
        <h3 v-if="test3" class="animated">test111111111</h3>
    </transition>
</div>
<div>
      <div class="handle" id="four" @click="animateChange($event,4)"><p class="rotate"></p></div>
      <transition enter-active-class="fadeInLeft" leave-active-class="fadeOutLeft" :duration="{ enter:400, leave:200 }">
        <h3 v-if="test4" class="animated">test111111111</h3>
    </transition>
</div>
</div>
    </el-row>
