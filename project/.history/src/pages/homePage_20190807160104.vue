...
import animate from 'animate.css'
    export default {
      ...
      methods:{
        ...
        animateChange(index){
          if(index===1)this.test1=!test.test1;
          else if(index===2)this.test2=!test.test2;
          else if(index===3)this.test3=!test.test3;
          else if(index===4)this.test4=!test.test4;
          else this.test5=!test.test5;
