...
<script>
    export default {
      ...
      created(){
        this.componentDetail=this.$route.params.detail;
      },
      mounted(){
        this.pullInfo();
      },
      methods:{
          pullInfo(){
            if(this.componentDetail!=={}){
              this.softId=this.componentDetail.id;
              this.softImg="data:image/jpg;base64,"+this.componentDetail.softIcon;
              this.softTitle=this.componentDetail.softName;
              this.softDescription=this.componentDetail.description;
              this.createTime=this.componentDetail.created;
              this.creator=this.componentDetail.creator;
              this.ifGet=this.componentDetail.auth;
              this.ifCollect=this.componentDetail.collect;
            }
          },
        //立即获取
        downSoft(){
            if(sessionStorage.getItem("username") === null){
              ...
              let param={
                ...
                softId:this.componentDetail.id
              };
